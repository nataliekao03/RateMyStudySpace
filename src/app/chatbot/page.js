      ...
      <div className="max-w-3xl mx-auto p-4">
        ...
        <div className="flex items-center gap-4 bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6 shadow-sm">
          ...
          <p className="text-gray-800 text-sm md:text-base">
            Hi there! I’m <strong>Nook</strong>, your personal study companion.
            I’m here to help you find the best study spaces nearby and offer
            study tips tailored to your needs!
          </p>
        </div>
