...
export default function page() {
  return (
    <div>
      <h1 className="text-4xl font-bold text-center mt-10">Review & Rating</h1>
      ...
      <button type="submit" className="border border-gray-300 px-4 py-2 rounded">Wifi</button>
      <button type="submit" className="border border-gray-300 px-4 py-2 rounded">Outlets</button>
      <button type="submit" className="border border-gray-300 px-4 py-2 rounded">Clean</button>
